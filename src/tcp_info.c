 ...
 * Based on information on http://wiki.freebsd.org/8.0TODO, I dont think this
 will be
 * fixed before v8.1 at the earliest.
 *
 * OSX has no support.
 *
 * I think MS Windows does support TCP_INFO, but iperf3 does not currently
 support Windows.
 */
...
void build_tcpinfo_message(struct iperf_interval_results *r, char *message) {
  ...
  sprintf(message, report_tcpInfo, r->tcpInfo.tcpi_snd_cwnd,
          ...
          r->tcpInfo.tcpi_unacked, r->tcpInfo.tcpi_sacked, r->tcpInfo.tcpi_lost,
          r->tcpInfo.tcpi_retrans, r->tcpInfo.tcpi_fackets, r->tcpInfo.tcpi_rtt,
