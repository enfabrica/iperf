...
int main(int argc, char **argv) {
  ...
  const char sha256Digest[] = "4816482f8b4149f687a1a33d61a0de6b611364ec0fb7adff"
                              "a59ff2af672f7232"; /* echo -n "This is a SHA256
                                                     test." | shasum -a256 */
  ...
  const char base64EncodeCheck[] =
      "VGhpcyBpcyBhIEJhc2U2NCB0ZXN0Lg=="; /* echo -n "This is a Base64 test." |
                                             b64encode -r - */
